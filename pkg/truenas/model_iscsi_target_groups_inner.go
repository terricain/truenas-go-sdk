...
// checks if the ISCSITargetGroupsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ISCSITargetGroupsInner{}
...
func (o ISCSITargetGroupsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ISCSITargetGroupsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varISCSITargetGroupsInner)
