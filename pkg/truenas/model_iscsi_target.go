...
// checks if the ISCSITarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ISCSITarget{}
...
func (o ISCSITarget) ToMap() (map[string]interface{}, error) {
...
func (o *ISCSITarget) UnmarshalJSON(bytes []byte) (err error) {
	...
	varISCSITarget := _ISCSITarget{}

	err = json.Unmarshal(bytes, &varISCSITarget)

	if err != nil {
		return err
	}

	*o = ISCSITarget(varISCSITarget)
